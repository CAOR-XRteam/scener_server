...
class Mediapipe:
    ...
    def __init__(self):
        ...
        base_options = python.BaseOptions(model_asset_path='model/mediapipe/gesture_recognizer.task', delegate=mp.tasks.BaseOptions.Delegate.GPU)
    ...
    def process_hand(self, skeletons, frame, hand):
        ...
        #Fill hand stuff
        if hand.index is not None and len(skeletons.multi_hand_landmarks) >= hand.index+1:
